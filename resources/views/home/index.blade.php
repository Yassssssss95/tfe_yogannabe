...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        let currentSlide = 0;
        const slideContainer = document.querySelector('.hero__slides');
...
<div class="content">
    <section class="hero">
        <div class="hero__slides">
            <div class="hero__slide" style="background-image: url('{{ asset('assets/irl7.jpg') }}')">
                <div class="hero__intro">
                    <h1>Bienvenue sur Yogannabe</h1>
                    <p>Découvrez la paix intérieure au cœur de l'Irlande</p>
                </div>
                <div class="hero__cta">
                    <a href="{{ route('retreats.index') }}" class="btn-cta">Voir nos séjours</a>
                </div>
            </div>
            <div class="hero__slide" style="background-image: url('{{ asset('assets/irl5.jpg') }}')">
                <div class="hero__intro">
                    <h1>Explorez l'Irlande</h1>
                    <p>Des retraites de yoga dans des paysages extraordinaires</p>
                </div>
                <div class="hero__cta">
                    <a href="{{ route('retreats.index') }}" class="btn-cta">Découvrir</a>
                </div>
            </div>
            <div class="hero__slide" style="background-image: url('{{ asset('assets/irl6.jpg') }}')">
                <div class="hero__intro">
                    <h1>Reconnexion</h1>
                    <p>Yoga et nature, une expérience unique</p>
                </div>
                <div class="hero__cta">
                    <a href="{{ route('booking.form') }}" class="btn-cta">Réserver</a>
                </div>
            </div>
        </div>
    </section>
...
Rejoignez-moi pour une aventure inoubliable, où le yoga et la nature se rencontrent pour créer une expérience unique.</p>
        ...
        <div class="presentation__cta">
            <a href="{{ route('booking.form') }}" class="btn-booking">Réserver une retraite</a>
        </div>
    </section>
